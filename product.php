...
$sql="SELECT * FROM product WHERE bestselling_id=01";
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
<title> Bumble bee| Best selling products</title>
</head>
<body>
<nav class="navbar">
...
<img class="ban banner_img" src="images/banner.png" alt="banner image" width="100%px" height="470px"> 
...
text-shadow: 0px 1px 2px #bbb;
    ...
    <div class="image">
        ...
        <button class="button"><a href="details.php?id=<?php echo $row['product_id']; ?>" class="btn btn-success" style="color:green";> <i class="fa fa-cart-plus"></i> Add to Cart</button> </a>
        </div>
          <?php
          }
          ?>
