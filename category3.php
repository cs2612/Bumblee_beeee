...
$sql="SELECT * FROM product WHERE category_id=03";
...
<li class="products">
<a class="active" href="produc.php"><i class="fa fa-shopping-basket"></i>Products<i class="fa fa-caret-down"></i></a>
<ul class="dropdown">
...
<img class="ban banner_img" src="images/banner3.png" alt="banner image" width="100%px" height="470px"> 
