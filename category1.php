...
$sql="SELECT * FROM product WHERE category_id=01";
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
<title> Bumble bee| Laptops</title>
</head>
<body>
<nav class="navbar">
...
<img class="ban banner_img" src="images/banner1.jpg" alt="banner image" width="100%px" height="470px"> 
