...
<input type="text" name="product_lable" class="form-control" required >
...
$product_label = $_POST['product_lable'];
...
$insert_product = "insert into product (product_name,category_id,image,stock,product_price,description,product_lable) values ('$product_title',$cat','$product_img',$product_stock,'$product_price','$product_desc','$product_label')";
