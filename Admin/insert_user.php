...
$insert_admin = "insert into admin (admin_name,admin_email,admin_pass,admin_contact) values ('$admin_name','$admin_email','$admin_pass','$admin_contact')";
...
echo "<script>window.open('admin index.php?view_users','_self')</script>";
