...
$sql="SELECT * FROM product WHERE category_id=06";
...
<img class="ban banner_img" src="images/banner5.jpg" alt="banner image" width="100%px" height="470px"> 
