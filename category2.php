...
$sql="SELECT * FROM product WHERE category_id=02";
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
<title> Bumble bee| Desktops</title>
</head>
<body>
<nav class="navbar">
...
<img class="ban banner_img" src="images/banner2.jpg" alt="banner image" width="100%px" height="470px"> 
